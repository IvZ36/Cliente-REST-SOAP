                ...
                <div class="row">
                    <div class="col-12 p-0">
                        <div class="card col-6 rounded-0 bg-light p-0 mx-auto mt-2">
                            ...
                            <div class="card-body">
                                <form action="/rest/acortar" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-outline-secondary my-2 my-sm-0">Acortar URL para el usuario</button>
                                </form>
                            </div>
                        </div>
                    </div>
